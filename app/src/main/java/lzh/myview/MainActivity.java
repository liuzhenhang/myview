...
public class MainActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.Auditprogress, R.id.CircularProgressView, R.id.MyCouponView, R.id.MyEditText, R.id.MyLinearProgressView, R.id.ScaleView, R.id.ScrollerView, R.id.MyScheduleView})
